...
public class Main {
    ...
    static int[][] m = new int[maxF][maxC];
    ...
    static int matriujoc[][]= new int[fila][columna];
    static int posPilota = columna / 2;
    static String pilota = " * ";
    static  String barra = "===";
    static int posbase = columna/2;
        ...
        for (int j = 0; j < columna; j++) {
            if(i==0 || i==fila-1)
                ...
                if (j>=negativespace && j<=columna-negativespace-1 ){
                    ...
                    applynegativespace = true; //inici de piràmide
                }
                ...
                for (int i = 0; i < fila; i++) {
                    for (int j = 0; j < columna; j++) {
                        if (matriujoc[i][j] == 1)
                            ...
                            System.out.print(pilota);   //col·locar pilota
                        } else if (matriujoc[i][j] == 3) {
